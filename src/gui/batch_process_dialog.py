...
SUPPORTED_FILTER_PRESETS: dict[str, tuple[str, ...]] = {
    "All Supported Formats": (
        ".pdf", ".docx", ".doc", ".txt", ".csv", ".tsv", ".xlsx", ".xlsm", ".xltx", ".xls",
        ".pptx", ".ppt", ".odt", ".ods", ".odp", ".rtf", ".log",
        ".jpg", ".jpeg", ".png", ".gif", ".bmp", ".webp", ".tiff", ".tif", ".ico", ".svg",
        ".mp3", ".wav", ".flac", ".m4a", ".aac", ".ogg", ".opus", ".wma", ".aiff", ".aif",
        ".mp4", ".avi", ".mkv", ".mov", ".wmv", ".flv", ".webm", ".m4v",
        ".zip", ".tar", ".gz", ".tgz", ".bz2", ".xz", ".7z",
        ".json", ".xml", ".html", ".htm", ".xhtml", ".yaml", ".yml", ".ini", ".cfg", ".conf", ".env", ".sql",
        ".py", ".pyw", ".js", ".ts", ".jsx", ".tsx", ".c", ".cpp", ".h", ".hpp", ".cs", ".java",
        ".go", ".rs", ".php", ".rb", ".swift", ".kt", ".sh", ".bat", ".ps1", ".md",
        ".db", ".sqlite", ".sqlite3",
    ),
    ...
    "Archives & Packages (*.zip, *.tar, *.gz, *.tgz, *.bz2, *.xz)": (
        ".zip", ".tar", ".gz", ".tgz", ".bz2", ".tbz2", ".xz", ".txz", ".7z",
    ),
    "Structured Data & Config (*.json, *.csv, *.xml, *.yaml, *.ini, *.sql)": (
        ".json", ".csv", ".tsv", ".xml", ".html", ".htm", ".yaml", ".yml",
        ".ini", ".cfg", ".conf", ".toml", ".env", ".sql",
    ),
    "Code & Scripts (*.py, *.js, *.html, *.css, *.json)": (
        ".py", ".pyw", ".js", ".ts", ".jsx", ".tsx", ".c", ".cpp", ".cc", ".h", ".hpp",
        ".cs", ".java", ".go", ".rs", ".php", ".rb", ".swift", ".kt", ".sh", ".bat", ".ps1",
        ".html", ".css", ".md", ".json",
    ),
